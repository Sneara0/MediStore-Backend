...
const getProfileService = async (userId) => {
    return prisma_1.default.user.findUnique({ where: { id: userId }, select: { id: true, name: true, email: true, role: true } });
};
...
const updateProfileService = async (userId, data) => {
    ...
    return prisma_1.default.user.update({ where: { id: userId }, data });
};
